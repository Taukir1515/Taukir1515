  ...
  #colorlib-aside .colorlib-footer {
    ...
    #colorlib-aside .colorlib-footer ul {
      ...
      #colorlib-aside .colorlib-footer ul li {
        ...
        #colorlib-aside .colorlib-footer ul li a i {
          font-size: 2.8rem; 
          ...
          padding: 4px;
                ...
                /* LinkedIn */
        #colorlib-aside .colorlib-footer ul li:nth-child(1) a {
          color: #0077b5;
        }

        /* GitHub */
        #colorlib-aside .colorlib-footer ul li:nth-child(2) a {
          color: #333;
        }

        /* Email */
        #colorlib-aside .colorlib-footer ul li:nth-child(3) a {
          color: #d93025; /* Gmail-style red */
        }
...
.js .animate-box {
  ...
  /* Fix mobile clickability for Contact section */
.colorlib-feature-link {
  display: flex;
  align-items: center;
  text-decoration: none;
  color: inherit;
...
.colorlib-feature.colorlib-feature-sm .colorlib-icon {
  position: relative;
  width: auto;
  height: auto;
  background: none;
...
.colorlib-feature.colorlib-feature-sm {
  display: flex;
  align-items: center;
  margin-bottom: 20px;
}
...
@media (max-width: 768px) {
  ...
  .colorlib-feature .colorlib-icon i {
    font-size: 28px; /* optional adjust for smaller screens */
  }
...
.colorlib-contact .colorlib-feature a {
  pointer-events: auto;
  z-index: 1001; /* above any container */
}
